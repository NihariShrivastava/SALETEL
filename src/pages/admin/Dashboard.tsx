...
import { FileText, CheckCircle2, Clock, Users, Loader2, Briefcase, PhoneCall, Settings, Save } from 'lucide-react';
      ...
      <Card className="p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-xs text-text-secondary">Configure the number of days before a lead triggers a notification.</p>
          </div>
        </div>
